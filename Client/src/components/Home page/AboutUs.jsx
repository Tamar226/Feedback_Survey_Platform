    ...
    <div className="about-us-container">
      ...
      <div className="testimonials">
        <div className="testimonial">
          <img src="/path/to/company1-logo.png" alt="Company 1 Logo" className="company-logo"/>
        ...
        <div className="testimonial">
          <img src="/path/to/company2-logo.png" alt="Company 2 Logo" className="company-logo"/>
          <div className="testimonial-content">
            <h4>Company 2</h4>
        ...
        <div className="testimonial">
          <img src="/path/to/company3-logo.png" alt="Company 3 Logo" className="company-logo"/>
          <div className="testimonial-content">
            <h4>Company 3</h4>
